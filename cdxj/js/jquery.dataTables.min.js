...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"第一页",sLast:"最后一页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"No data available in table",sInfo:"当前 _START_ 至 _END_ &nbsp;&nbsp;总共 _TOTAL_ 条",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"展出 _MENU_ 每页记录",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"搜索:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},
